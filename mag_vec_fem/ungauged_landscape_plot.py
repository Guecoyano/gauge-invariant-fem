...
for B in (0,5,10,20,30,40):
    ...
    namedata=os.path.realpath(os.path.join(res_path,'landscapes','l'+str(lnm)+'B'+str(B)+'V'+str(V_max)+'h'+str(int(1/h))+'v'+str(pot_version)+'.npz'))
    ...
    t='deltaw_l'+str(lnm)+'B'+str(B)+'V'+str(V_max)+'h'+str(int(1/h))+'v'+str(pot_version)
    ...
    t='u_l'+str(lnm)+'B'+str(B)+'V'+str(V_max)+'h'+str(int(1/h))+'v'+str(pot_version)
    plt.savefig(os.path.realpath(os.path.join(res_path,t)))
    plt.clf()
    plt.close()'''
