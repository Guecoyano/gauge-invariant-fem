...
plt.title(r'2D Magnetic Schrödinger : first eigenfunction (modulus), $E_1=%d$)'%(w[0]))
...
plt.title(r'2D Magnetic Schrödinger : third eigenfunction (modulus), $E_3=%d$)'%(w[2]))
...
plt.title(r'2D Magnetic Schrödinger : fifth eigenfunction (modulus), $E_5=%d$)'%(w[4]))
...
plt.title(r'2D Magnetic Schrödinger : first eigenfunction (modulus), $E_1=%d$)'%(w2[0]))
...
plt.title(r'2D Magnetic Schrödinger : third eigenfunction (modulus), $E_3=%d$)'%(w2[2]))
...
plt.title(r'2D Magnetic Schrödinger : fifth eigenfunction (modulus), $E_5=%d$)'%(w2[4]))
plt.show()
plt.close()